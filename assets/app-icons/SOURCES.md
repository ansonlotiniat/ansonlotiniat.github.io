...
Prepared 2026-07-31 from a Mac running macOS Tahoe 26.3 for the AnsonOS interface.
...
The `.icns` resources were converted to PNG with macOS `sips` and resized only.
